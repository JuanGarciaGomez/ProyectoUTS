...
import com.movilidad.proyectouts.activities.driver.UpdateProfileDriverActivity;
...
import com.movilidad.proyectouts.providers.ImagesProvider;
import com.movilidad.proyectouts.utils.FileUtil;
...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageViewProfile = findViewById(R.id.imageViewProfileClient);
        mButtonUpdate = findViewById(R.id.btnUpdateProfileClient);
        mTextViewName = findViewById(R.id.textInputName);
        mCircleImageBack = findViewById(R.id.circleImageBackClient);
