package com.movilidad.proyectouts.activities.driver;
...
import com.movilidad.proyectouts.providers.ClientBookingProvider;
import com.movilidad.proyectouts.providers.ClientProvider;
import com.movilidad.proyectouts.providers.GeofireProvider;
import com.movilidad.proyectouts.providers.GoogleApiProvider;
import com.movilidad.proyectouts.providers.NotificationProvider;
import com.movilidad.proyectouts.providers.TokenProvider;
import com.movilidad.proyectouts.utils.DecodePoints;
...
public class MapDriverBookingActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void startBooking() {
        ...
        mMap.clear();
        mMap.addMarker(new MarkerOptions().position(mDestinationLatLng).title("Destino").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin_blue)));
        ...
        mClientBookingProvider.getClientBooking(mExtraClientId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mMap.addMarker(new MarkerOptions().position(mOriginLatLng).title("Recoger aqui").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
